...
export default function ShippingPage() {
  return (
    <div className="max-w-screen-md mx-auto px-6 md:px-8 py-16 md:py-24">
      <p className="text-xs font-semibold text-chako-dark/40 uppercase tracking-widest mb-3">Delivery</p>
      <h1 className="text-3xl md:text-4xl font-bold mb-10">Shipping & Returns</h1>

      <div className="space-y-10 text-sm text-chako-dark/70 leading-relaxed">
        <section>
          <h2 className="text-base font-bold text-chako-dark mb-4">Shipping Rates & Times</h2>
          <div className="divide-y divide-black/8 border border-black/8 rounded-2xl overflow-hidden">
            {[
              ...
              <div key={zone} className="grid grid-cols-3 px-4 py-3.5 text-xs">
                <span className="font-semibold text-chako-dark">{zone}</span>
                <span>{time}</span>
                <span>{cost}</span>
              </div>
            ))}
          </div>
          <p className="mt-3 text-xs text-chako-dark/45">
            Orders placed before 3PM GST on business days typically ship the same day.
          </p>
        </section>

        <section>
          <h2 className="text-base font-bold text-chako-dark mb-3">Returns Policy</h2>
        ...
        <section>
          <h2 className="text-base font-bold text-chako-dark mb-3">Damaged or Incorrect Items</h2>
        ...
        <section>
          <h2 className="text-base font-bold text-chako-dark mb-3">Warranty</h2>
