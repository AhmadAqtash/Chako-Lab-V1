...
export default function ContactPage() {
  return (
    <div className="max-w-screen-md mx-auto px-6 md:px-8 py-16 md:py-24">
      <p className="text-xs font-semibold text-chako-dark/40 uppercase tracking-widest mb-3">Get In Touch</p>
      <h1 className="text-3xl md:text-4xl font-bold mb-4">Contact Us</h1>
      <p className="text-chako-dark/60 text-sm leading-relaxed mb-10 max-w-md">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        {[
          ...
          <div key={label} className="bg-chako-accent rounded-2xl px-5 py-4">
            <p className="text-xs font-semibold text-chako-dark/40 uppercase tracking-widest mb-1">{label}</p>
            {href ? (
