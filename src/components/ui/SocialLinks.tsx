...
interface Props {
  /** Icon size in px */
  size?: number;
  /** Classes applied to each link (sizing/shape/hover come from the caller) */
  linkClassName?: string;
  className?: string;
}

// Instagram + TikTok icon links (lucide carries no brand icons).
// Server-safe — plain SVGs, no client JS.
export default function SocialLinks({ size = 16, linkClassName, className }: Props) {
  return (
