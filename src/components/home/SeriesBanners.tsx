            ...
            >
              ...
              <div className="relative aspect-[3/4] w-full overflow-hidden rounded-2xl">
                ...
                <div className="absolute bottom-0 inset-x-0 p-4">
                  <span className="inline-flex items-center gap-1.5 bg-white/90 backdrop-blur-sm text-chako-dark text-sm font-bold px-4 py-2 rounded-full shadow-sm transition-all duration-200 group-hover:bg-white group-hover:shadow-md">
                    {label}
                    <svg
                      ...
                      className={`opacity-60 transition-transform duration-200 group-hover:translate-x-1 ${isAr ? 'rotate-180 group-hover:translate-x-0 group-hover:-translate-x-1' : ''}`}
                    >
